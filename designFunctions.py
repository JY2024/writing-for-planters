...
def generate_label(text="", background_color="light grey", font_size="20px", bold=False, border=False, size=QSize(870, 50), alignment=Qt.AlignLeft):
    label = QLabel(text)
    label.setAlignment(alignment)
    return general_visual_setup(label, background_color, font_size, bold, border, size)

def generate_button(text="", background_color="light grey", font_size="15px", bold=False, border=False, size=QSize(200, 50), checkable=False):
